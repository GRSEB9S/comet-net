...
# Last Modification: February 11, 2018										  #
###################################################################################################################
...
def plot_training(history):
  ...
  pylab.savefig('plot_collections/accuracy_epochs{}_batch{}'.format(NB_EPOCHS,BAT_SIZE))
  pylab.figure()
  ...
  pylab.savefig('plot_collections/loss_epochs{}_batch{}'.format(NB_EPOCHS,BAT_SIZE))
#  pylab.show()
